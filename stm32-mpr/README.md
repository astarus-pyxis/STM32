...
## C driver to interface MPR pressure sensor with an STM32 microcontroller

The driver itself is made of the files MPR.c and MPR.h.
...
The C files  MPR.c and console.c shall be placed in the Core > Src folder of the project, and MPR.h, errors.h and console.h in the Core > Inc folder.
